...
import { __assign, __read, __extends, __values } from 'tslib';
...
ScrollbarRef = /** @class */ (function () {
    ...
    function (e) {
         ...
         */
        function (value) {
            return _this.scrollbarRef.scrollTo(__assign({}, _this.mapToScrollToOption(value), { duration: coerceNumberProperty(_this.scrollbarRef.trackClickScrollDuration) }));
        })), tap((/**
         * @return {?}
         */
