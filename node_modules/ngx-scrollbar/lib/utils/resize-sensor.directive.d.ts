...
export declare class ResizeObserverFactory {
    ...
    static ngInjectableDef: ɵngcc0.ɵɵInjectableDef<ResizeObserverFactory>;
}
export declare class ResizeSensor implements AfterContentInit, OnDestroy {
    ...
    static ngDirectiveDef: ɵngcc0.ɵɵDirectiveDefWithMeta<ResizeSensor, "[resizeSensor]", never, { 'debounce': "sensorDebounce", 'disabled': "sensorDisabled" }, {}, never>;
}
