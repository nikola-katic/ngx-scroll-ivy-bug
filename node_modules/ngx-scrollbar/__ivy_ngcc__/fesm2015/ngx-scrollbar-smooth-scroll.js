...
SmoothScrollManager.ngInjectableDef = ɵngcc0.ɵɵdefineInjectable({ token: SmoothScrollManager, factory: function SmoothScrollManager_Factory(t) { return new (t || SmoothScrollManager)(ɵngcc0.ɵɵinject(NgZone), ɵngcc0.ɵɵinject(Directionality), ɵngcc0.ɵɵinject(DOCUMENT), ɵngcc0.ɵɵinject(PLATFORM_ID), ɵngcc0.ɵɵinject(SMOOTH_SCROLL_OPTIONS, 8)); }, providedIn: 'root' });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(SmoothScrollManager, [{
        type: Injectable,
        args: [{
                providedIn: 'root'
            }]
    }], function () { return [{ type: NgZone }, { type: Directionality }, { type: undefined, decorators: [{
                type: Inject,
                args: [DOCUMENT]
            ...
            }] }]; }, { constructor: [], _zone: [], _dir: [], _document: [], _platform: [], _onGoingScrolls: [], _defaultOptions: [], _w: [], _now: [], _scrollElement: [], _getElement: [], _initSmoothScroll: [], _isFinished: [], _interrupted: [], _destroy: [], _step: [], _applyScrollToOptions: [], scrollTo: [], scrollToElement: [] });
/** @nocollapse */
...
SmoothScroll.ngDirectiveDef = ɵngcc0.ɵɵdefineDirective({ type: SmoothScroll, selectors: [["", "smoothScroll", ""], ["", "smooth-scroll", ""]], factory: function SmoothScroll_Factory(t) { return new (t || SmoothScroll)(ɵngcc0.ɵɵdirectiveInject(ElementRef), ɵngcc0.ɵɵdirectiveInject(SmoothScrollManager)); }, exportAs: ["smoothScroll"] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(SmoothScroll, [{
        type: Directive,
        args: [{
                selector: '[smoothScroll], [smooth-scroll]',
                exportAs: 'smoothScroll'
            }]
    }], function () { return [{ type: ElementRef }, { type: SmoothScrollManager }]; }, { constructor: [], element: [], smoothScroll: [], scrollTo: [], scrollToElement: [] });
/** @nocollapse */
...
SmoothScrollModule.ngModuleDef = ɵngcc0.ɵɵdefineNgModule({ type: SmoothScrollModule });
/*@__PURE__*/ ɵngcc0.ɵɵsetNgModuleScope(SmoothScrollModule, { declarations: [SmoothScroll], exports: [SmoothScroll] });
/*@__PURE__*/ ɵngcc0.ɵsetClassMetadata(SmoothScrollModule, [{
        type: NgModule,
        args: [{
...
SmoothScrollModule.ngInjectorDef = ɵngcc0.ɵɵdefineInjector({ factory: function SmoothScrollModule_Factory(t) { return new (t || SmoothScrollModule)(); } });
